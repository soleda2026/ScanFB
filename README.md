...
Phase 10A chi chung minh typed local `PreparedPageSnapshot` -> `RawPost` extraction contract bang deterministic fixtures. No khong doc live Facebook DOM, khong so huu browser/session/cookie/credential va khong chay scan; browser/page acquisition va selector validation duoc defer sang Phase 10B+.
