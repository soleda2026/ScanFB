...
- Future SQLite design dung `BatchRecord` lam root aggregate, `BatchRecordID` van authoritative, moi ordered collection co position explicit, va moi source post reference mot preserved post occurrence thay vi rely vao `PostID`.
