...
- Phase 10B+: real user-prepared browser/page acquisition and selector validation remain separate controlled milestones with fixture regression and manual validation without secrets.
