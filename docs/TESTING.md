...
- Phase 10B2b: production selector implementation remains incomplete and blocked until a separate milestone approves a bounded read-only acquisition representation with stable post-level evidence.
